...
class ConsumerThread extends Thread{
	...
	public void run(){
		synchronized(cal){
		try{
		System.out.println("consumer Thread going to wait state::"+Thread.currentThread().getName());
		cal.wait();
		}catch(Exception ex){
			ex.printStackTrace();
		}
		System.out.println("consumer Thread::"+Thread.currentThread().getName());
		System.out.println("consumer Count value::"+cal.count);
		}
	}
}
...
class ProducerThread extends Thread{
	...
	public void run(){
		...
		cal.count = sum;
		System.out.println("Producer count value generated and notifying::"+cal.count);
		cal.notifyAll();
		}
	}
}
